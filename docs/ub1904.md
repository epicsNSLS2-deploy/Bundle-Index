...
Variable|Value
------|--------
Location|`/ad-nfs/epics/production/R3-10/Ubuntu19`
Build Config Path|`/ad-nfs/epics/production/R3-10/Ubuntu19/build-config`
Bundle Name|`NSLS2_AD_R3-10_Prod_ubuntu_19.04_2020-09-25`
installSynApps Version|R2-6-29-gb5f2019
Python 3 Version|3.7.3
OS Class|ubuntu_19.04
Build Date|2020-09-25 18:51:53.896291

To regenerate sources used to build the bundle, use the following commands:
```bash
git clone https://github.com/epicsNSLS2-deploy/installSynApps && cd installSynApps
git checkout b5f201951ec052100579eb9c4733d2f153317733
python3 -u installCLI.py -c /ad-nfs/epics/production/R3-10/Ubuntu19/build-config -p
```
Make sure to have Python 3.7.3 installed, and be running on a ubuntu_19.04 machine
