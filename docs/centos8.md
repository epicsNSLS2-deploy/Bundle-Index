...
Variable|Value
------|--------
Location|`/ad-nfs/epics/production/R3-10/CentOS8`
Build Config Path|`/ad-nfs/epics/production/R3-10/CentOS8/build-config`
Bundle Name|`NSLS2_AD_R3-10_Prod_centos_8_2020-09-25`
installSynApps Version|R2-6-29-gb5f2019
Python 3 Version|3.6.8
OS Class|centos_8
Build Date|2020-09-25 18:02:53.703510

To regenerate sources used to build the bundle, use the following commands:
```bash
git clone https://github.com/epicsNSLS2-deploy/installSynApps && cd installSynApps
git checkout b5f201951ec052100579eb9c4733d2f153317733
python3 -u installCLI.py -c /ad-nfs/epics/production/R3-10/CentOS8/build-config -p
```
Make sure to have Python 3.6.8 installed, and be running on a centos_8 machine
